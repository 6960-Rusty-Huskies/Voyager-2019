...
public class RobotMap {
  // PWM
  public static final int DRIVE_RIGHT_TOP_CHANNEL = 4;
  public static final int DRIVE_RIGHT_FRONT_CHANNEL = 5;
  public static final int DRIVE_RIGHT_BACK_CHANNEL = 2;

  public static final int DRIVE_LEFT_TOP_CHANNEL = 3;
  public static final int DRIVE_LEFT_FRONT_CHANNEL = 5;
  public static final int DRIVE_LEFT_BACK_CHANNEL = 1;

  public static final int ARM_MOTOR_TOP_CHANNEL = 8;
  public static final int ARM_MOTOR_BOTTOM_CHANNEL = 9;
  ...
  public static final int OPERATOR_LEFT_JOYSTICK_PORT = 2;
  public static final int OPERATOR_RIGHT_JOYSTICK_PORT = 3;

  public static final int CARGO_LOW_PORT = 7;
  public static final int CARGO_MEDIUM_PORT = 6;
  public static final int CARGO_HIGH_PORT = 5;
  public static final int CARGO_GRAB_PORT = 4;

  public static final int HATCH_LOW_PORT = 3;
  public static final int HATCH_MEDIUM_PORT = 2;
  public static final int HATCH_HIGH_PORT = 1;
  public static final int HATCH_GRAB_PORT = 0;

  public static final int CLAW_TOGGLE_PORT = 8;
  public static final int ELEVATOR_TOGGLE_PORT = 9;
  ...
  public static final int ARM_GEAR_RATIO = 1 / 1;
  /** The gear ratio of the wrist encoder. Used in the setDistancePerPulse() function. */
  public static final int WRIST_GEAR_RATIO = 45 / 1;
